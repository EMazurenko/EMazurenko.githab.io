...
function App() {
  return (
    <div className="App">
      ...
      <header className="App-subheader">Зачем мне обучение</header>
      <div className="App-text-block">
        <p>
          ...
          <a className="App-link" href="https://otus.ru/lessons/unity-basic">
      ...
      <header className="App-subheader">Что я умею</header>
      <div className="App-text-block">
        <p>
      ...
      <header className="App-subheader">Кто я такой</header>
      <div className="App-text-block">
        <p>
