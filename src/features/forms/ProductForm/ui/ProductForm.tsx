...
import { useProductStore } from 'src/features/forms/ProductForm/model/useProductStore';
...
const ProductForm: FC<ProductFormProps> = ({ t, productId, onSubmit }) => {
  ...
  const { initProduct, saveProduct, findCategory, getCategoryOptions } = useProductStore(productId);
  const {
    register,
    handleSubmit,
    reset,
